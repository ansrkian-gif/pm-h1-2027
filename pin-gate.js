(function () {
  ...
  wrap.style.cssText =
    "position:fixed;inset:0;z-index:99999;background:#0f3d3e;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;color:#fff;font-family:DM Sans,system-ui,sans-serif";
  wrap.innerHTML =
    '<div style="font-weight:800;font-size:1.45rem">PM H1 2027</div>' +
    '<input id="pinIn" type="password" inputmode="numeric" maxlength="8" placeholder="PIN" autocomplete="off" style="font-size:1.35rem;padding:12px 16px;border-radius:12px;border:0;width:190px;text-align:center">' +
